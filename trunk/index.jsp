...
<html>
	...
	<body>
	    ...
	    <s:url action="movie/list" id="movieList"/>

        <div style="width: 300px;border-style: solid">
        	<div style="text-align: right;">
    			<s:a theme="ajax" notifyTopics="/movie.refresh">Refresh Movies</s:a>
    		</div>
    		<s:div id="movies" theme="ajax" href="%{movieList}" loadingText="Loading..." listenTopics="/movie.refresh"/>
        </div>
