 ...
 * 
 */
public abstract class AbstractStrutsTestCase extends TestCase {
	...
	protected String[] getConfigLocations() {
		String classDir = getClass().getResource("./").getFile();
        String webappDir = classDir.substring(0, classDir.indexOf("WEB-INF"));
        return new String[] {"file:" + webappDir + "/WEB-INF/applicationContext.xml"};
	}
    ...
    protected void setUp() throws Exception {
        if( applicationContext == null ) {
            ...
            servletContext.addInitParameter(ContextLoader.CONFIG_LOCATION_PARAM, getConfigLocations()[0]);
        ...
        params.put("actionPackages", "net.dromard.movies.action");
